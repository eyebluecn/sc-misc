...
require (
	...
	github.com/eyebluecn/sc-misc-idl v0.0.0-20240602103432-2032ae3b7125
...
require (
	...
	github.com/eyebluecn/sc-subscription-idl v0.0.0-20240601165501-d1e730c48bfc // indirect
